...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_1_Pin | LED_2_Pin | LED_3_Pin | D_Pin | Tube_4_Pin | Tube_3_Pin | Tube_2_Pin | Tube_1_Pin | A_Pin | B_Pin | C_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LED_1_Pin LED_2_Pin LED_3_Pin D_Pin
                           Tube_4_Pin Tube_3_Pin Tube_2_Pin Tube_1_Pin
                           A_Pin B_Pin C_Pin */
  GPIO_InitStruct.Pin = LED_1_Pin | LED_2_Pin | LED_3_Pin | D_Pin | Tube_4_Pin | Tube_3_Pin | Tube_2_Pin | Tube_1_Pin | A_Pin | B_Pin | C_Pin;
